...
var log = logf.Log.WithName("controller_hubcluster")
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileHubCluster{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &onpremv1alpha1.HubCluster{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcileHubCluster) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set HubCluster instance as the owner and controller
...
func newPodForCR(cr *onpremv1alpha1.HubCluster) *corev1.Pod {
